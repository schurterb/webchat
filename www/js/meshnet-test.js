...
var WebRTCTestApp = function(loadingParams, log_level=3) {
  ...
  this.wcService.negotiator_.onlocalstreamadded = function(event) {
    console.log("[test]: onlocalstreamadded event : ",event);
  }.bind(this);
  this.wcService.negotiator_.onremotestreamadded = function(event) {
    console.log("[test]: onremotestreamadded event : ",event);
  }.bind(this);
